...
```{r}
dat.nooutliers.reduced.logtransform <- dat.nooutliers.reduced
...
dat.nooutliers.reduced$CLTV <- (dat.nooutliers.reduced$CLTV^bc.lam - 1) / bc.lam
...
TODO: evaluate multiple prediction metrics using our best model
TODO: compare prediction metrics to neural net?
