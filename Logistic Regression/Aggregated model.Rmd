...
par(mfrow=c(2,2))
boxplot(res~Gender,xlab="Age Group",ylab = "Std residuals",data = newdata)
boxplot(res~`Senior Citizen`,xlab="Gender",ylab = "Std residuals",data = newdata)
boxplot(res~Partner,xlab="Gender",ylab = "Std residuals",data = newdata)
boxplot(res~Dependents,xlab="Gender",ylab = "Std residuals",data = newdata)
boxplot(res~`Phone Service`,xlab="Gender",ylab = "Std residuals",data = newdata)
boxplot(res~`Multiple Lines`,xlab="Gender",ylab = "Std residuals",data = newdata)
boxplot(res~`Internet Service`,xlab="Gender",ylab = "Std residuals",data = newdata)
boxplot(res~Tenure,xlab="Gender",ylab = "Std residuals",data = newdata)
...
```{r}
#removing tenure
drop <- c("Tenure", "Dependents", "`Multiple Lines`")
...
```{r}
dat.reduced_2$`Churn Value` = as.numeric(dat.reduced_3$`Churn Value`)
