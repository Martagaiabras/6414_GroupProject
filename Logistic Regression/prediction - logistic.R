...
predictTrain = predict(full.model, type="response")
...
#full model
predictTest = predict(full.model, type = "response", newdata = test)
...
#step model
predictStep = predict(step_model, type = "response", newdata = test)
...
#step model
predictLasso = predict(lasso_model, type = "response", newdata = test)
#table(test$`Churn Value`, predictLasso >= 0.2)
